...
- (JSQMessagesBubbleImage *)jsq_messagesBubbleImageWithColor:(UIColor *)color flippedForIncoming:(BOOL)flippedForIncoming
{
    ...
    if (!flippedForIncoming) {
        UIImage *temp = [normalBubble jsq_imageMaskedWithColor:[UIColor colorWithRed:229/255.0f green:229/255.0f blue:229/255.0f alpha:1]];
        normalBubble = [self jsq_horizontallyFlippedImageFromImage:temp];
        highlightedBubble = [self jsq_horizontallyFlippedImageFromImage:temp];
    }
