 ...
 *  @discussion The default value is `8.0f`.
 */
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *micWidthConstrain;
@property (assign, nonatomic) CGFloat rightContentPadding;
@property (weak, nonatomic) IBOutlet UIView *micBaseView;
...
@property (weak, nonatomic) IBOutlet UIView *textViewholderView;
