...
+ (UIButton *)defaultAccessoryButtonItem
{
    ...
    UIImage *normalImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor whiteColor]];
//    UIImage *highlightedImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor darkGrayColor]];

    UIButton *accessoryButton = [[UIButton alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 40, 32.0f)];
