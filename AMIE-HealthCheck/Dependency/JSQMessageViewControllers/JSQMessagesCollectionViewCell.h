...
@property (weak, nonatomic) IBOutlet UIView *amieBottomView;
@property (weak, nonatomic) IBOutlet UIView *amieTopBorderView;

@property (weak, nonatomic) IBOutlet UIImageView *amieBottomIcon;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *amieHeightConstrain;

@property (weak, nonatomic) IBOutlet UITextView *amieBottomContentLbl;
