...
- (void)setBackgroundColor:(UIColor *)backgroundColor
{
    ...
    self.textViewholderView.layer.borderWidth = 0.5f;
    self.textViewholderView.layer.borderColor = [UIColor lightGrayColor].CGColor;
    self.textViewholderView.layer.cornerRadius = 18;
    self.textViewholderView.clipsToBounds = true;
}
