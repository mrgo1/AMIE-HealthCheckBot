...
- (void)toggleSendButtonEnabled
{
    ...
    if (self.sendButtonOnRight) {
        if (!hasText) {
            [self.contentView.rightBarButtonItem setImage:[UIImage imageNamed:@"disabledSal"] forState:UIControlStateNormal];
        }else
        {
          [self.contentView.rightBarButtonItem setImage:[UIImage imageNamed:@"sendIcon"] forState:UIControlStateNormal];
        }
