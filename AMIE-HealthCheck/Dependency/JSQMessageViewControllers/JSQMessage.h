...
@property (copy, nonatomic, readonly) NSAttributedString *content;

@property (copy, nonatomic, readonly) NSString *viewTypeName;

@property (assign, nonatomic, readonly) BOOL hasBelowView;
...
- (instancetype)initWithSenderId:(NSString *)senderId
               senderDisplayName:(NSString *)senderDisplayName
                            date:(NSDate *)date
                            text:(NSString *)text ViewType:(NSString *)viewType content:(NSAttributedString *)content;
